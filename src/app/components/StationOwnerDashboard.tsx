              ...
              <div className="p-5 space-y-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-emerald-400/10 rounded-lg border border-emerald-400/20 flex items-center justify-center">
                          <DollarSign className="w-4 h-4 text-emerald-400" />
                        </div>
                        <span className="text-xs text-zinc-400 font-medium">Bugün Gelir</span>
                      </div>
                      <div className="text-2xl font-bold text-zinc-100">{totalRevenue.toFixed(0)} ₺</div>
                      <div className="text-xs text-emerald-400 mt-1">↑ %12 dün'e göre</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-blue-400/10 rounded-lg border border-blue-400/20 flex items-center justify-center">
                          <Activity className="w-4 h-4 text-blue-400" />
                        </div>
                        <span className="text-xs text-zinc-400 font-medium">Aktif Oturum</span>
                      </div>
                      <div className="text-2xl font-bold text-zinc-100">{totalSessions}</div>
                      <div className="text-xs text-zinc-400 mt-1">{totalActivePoints}/{totalPoints} nokta aktif</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-purple-400/10 rounded-lg border border-purple-400/20 flex items-center justify-center">
                          <TrendingUp className="w-4 h-4 text-purple-400" />
                        </div>
                        <span className="text-xs text-zinc-400 font-medium">Doluluk Oranı</span>
                      </div>
                  ...
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-amber-400/10 rounded-lg border border-amber-400/20 flex items-center justify-center">
                          <MapPin className="w-4 h-4 text-amber-400" />
                        </div>
                        <span className="text-xs text-zinc-400 font-medium">İstasyonlar</span>
                      </div>
                      <div className="text-2xl font-bold text-zinc-100">{stations.length}</div>
                      <div className="text-xs text-zinc-400 mt-1">{stations.filter(s => s.status === 'operational').length} aktif</div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="space-y-3">
                  <Card className="bg-zinc-900 border-amber-700/40">
                    <CardContent className="p-4 flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm text-zinc-100">Bakım Gerekiyor</div>
                        ...
                        <Button size="sm" variant="outline" className="mt-2 border-amber-700/50 text-amber-300 hover:bg-amber-950/30" onClick={() => toast.info('Servis talebi oluşturuldu')}>
                          Servis Talep Et
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-zinc-900 border-blue-700/40">
                    <CardContent className="p-4 flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm text-zinc-100">Yüksek Doluluk</div>
                        <div className="text-xs text-zinc-300 mt-1">Balçova AVM %83 doluluk oranıyla pik seviyede. Yeni şarj noktası eklemeyi düşünün.</div>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-zinc-900 border-emerald-700/40">
                    <CardContent className="p-4 flex items-start gap-3">
                      <Check className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                      <div>
                        <div className="font-semibold text-sm text-zinc-100">Güçlü Performans</div>
                        <div className="text-xs text-zinc-300 mt-1">Narlıdere Merkez bu hafta %12 gelir artışı gösterdi. Mevcut strateji iyi çalışıyor.</div>
                      </div>
                    </CardContent>
                  </Card>
                </div>
